/**
 * scripts/add-colunas-descricao-bem.mjs
 *
 * Cria as colunas da "Descrição do bem" (para o catálogo do leilão público
 * coletivo) nas listas de veículo:
 *   MARCA_MODELO, ANO_FAB_MODELO, COR, RENAVAM
 * em Bens_CEGOC, Bens_DPJ_GC99, Bens_PCDF_1HIGEIA, Bens_PCDF_2HIGEIA.
 *
 *   node scripts/add-colunas-descricao-bem.mjs            # dry-run
 *   node scripts/add-colunas-descricao-bem.mjs --apply
 */
...
const COLUNAS = ['MARCA_MODELO', 'ANO_FAB_MODELO', 'COR', 'RENAVAM'];
const ABAS = ['Bens_CEGOC', 'Bens_DPJ_GC99', 'Bens_PCDF_1HIGEIA', 'Bens_PCDF_2HIGEIA'];
